...
Due to the suboptimal user experience with the official [Fyne](https://fyne.io/) documentation, where some examples even lack illustrations, we plan to maintain a new version.
