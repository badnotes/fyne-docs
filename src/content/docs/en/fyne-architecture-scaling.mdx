...
![Hello normal size](/images/architecture/hello-normal.png)  
Standard size

![Hello small size](/images/architecture/hello-small.png)  
FYNE\_SCALE=0.5

![Hello large size](/images/architecture/hello-large.png)  
FYNE\_SCALE=2.5